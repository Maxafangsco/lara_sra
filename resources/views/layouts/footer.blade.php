...
<!-- start footer here -->
          ...
          <footer class=" text-center text-white footer_body">
            ...
            <div class="container p-4">
              ...
              <section class="mb-4">
                <p>
                Quality health care remains a luxury for most of Africa and Cameroon in particular.
                 We die of preventable causes partly because little to nothing is known on disease patterns in our community. 
                  ...
                  <div class="col-4 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled mb-0">
                      ...
                      <i class="fa fa-home"></i>
                        <a href="#!" class="text-white">Yoaunde District, Cameroon</a>
                      </li>
                      <li>
                      <i class="fa fa-phone"></i>
                        <a href="#!" class="text-white">+237 679 894 30</a>
                      </li>
                      <li>
                      <i class="fa fa-envelope-o"></i>
                        <a href="#!" class="text-white">info@sra-cm.org</a>
                      </li>
                    </ul>
                  </div>
                  <!--Grid column-->
